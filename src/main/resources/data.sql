...
('honning', 1, 'spsk', 6),
('kartofler', 1, 'kg', 6),
('paprika', 1, 'knivspids', 6),
('rosiner', 2, 'spsk', 6),
('solsikkekerner', 1, 'spsk', 6),

('burgerboller', 4, 'stk', 7),
('avocado', 1, 'stk', 7),
('blandet salat', 125, 'g', 7),
('halloumi', 200, 'g', 7),
('frisk mynte', 1, 'håndfuld', 7),
('rødløg', 2, 'stk', 7),
('mayonnaise', 2, 'spsk', 7),

('burgerboller', 4, 'stk', 8),
('avocado', 2, 'stk', 8),
('rødløg', 0.5, 'stk', 8),
('hvidløg', 1, 'fed', 8),
('spidskommen', 1, 'tsk', 8),
('citronsaft', 1, 'spsk', 8),
('flagesalt', 1, 'tsk', 8),
('hakket oksekød', 400, 'g', 8),
('cheddar ost', 4, 'skiver', 8),
('jalapenos', 30, 'g', 8),
('salatblade', 125, 'g', 8),
('tomat', 2, 'stk', 8),
('mayonnaise', 2, 'spsk', 8),
...
('quinoa', 150, 'g', 9),
('edamamebønner', 75, 'g', 9),
('rucola', 125, 'g', 9),
('mango', 2, 'stk', 9),
('avocado', 2, 'stk', 9),
('cashewnødder', 50, 'g', 9),
('frisk koriander', 1, 'håndfuld', 9),
('hvidløg', 1, 'fed', 9),
('revet ingefær', 1, 'tsk', 9),
('lime', 1, 'stk', 9),

('karry', 1, 'spsk', 10),
('spidskommen', 1, 'tsk', 10),
('stødt koriander', 1, 'tsk', 10),
('løg', 1, 'stk', 10),
('hvidløg', 2, 'fed', 10),
('blomkål', 250, 'g', 10),
('gulerødder', 75, 'g', 10),
...
('salatblade', 150, 'g', 11),
('laksefilet', 300, 'g', 11),
('tørret dild', 1, 'tsk', 11),
('citron', 1, 'stk', 11),
('stenbiderrogn', 50, 'g', 11),
('rødløg', 1, 'stk', 11),
('dild', 1, 'håndfuld', 11),
('creme fraiche', 1, 'dl', 11),

('polenta mel', 250, 'g', 12),
('vand', 1, 'l', 12),
('salt', 1, 'nip', 12),
('olivenolie', 4, 'spsk', 12),
('frisk rosmarin', 3, 'stængler', 12),
('creme fraiche', 1, 'dl', 12),
('mayonnaise', 2, 'spsk', 12),
('parmesan', 1, 'spsk', 12),
('æblecidereddike', 1, 'dryp', 12),

('bagekartoffel', 1, 'kg', 13),
('olivenolie', 3, 'spsk', 13),
('flagesalt', 2, 'tsk', 13),
('okseinderlår', 600, 'g', 13),
('æggeblomme', 2, 'stk', 13),
('frisk estragon', 1, 'spsk', 13),
('kapers', 1, 'spsk', 13),
('cornichoner', 2, 'spsk', 13),
('worcestershire sauce', 1, 'tsk', 13),
('tabasco', 3, 'dråber', 13),
('peberrod', 1, 'tsk', 13),
('skalotteløg', 2, 'stk', 13),
('dijon sennep', 2, 'tsk', 13),
('aioli', 1, 'dl', 13),
...
('salt', 1, 'nip', 14),
('mandler', 75, 'g', 14),
('digestive kiks', 120, 'g', 14),
('smør', 125, 'g', 14),
('vaniljestang', 1, 'stk', 14),
('flormelis', 75, 'g', 14),
('kold risengrød', 300, 'g', 14),
('flødeost', 150, 'g', 14),
('husblas', 3, 'ark', 14),
('piskefløde', 3, 'dl', 14),
('kirsebærsaft', 300, 'g', 14),
('chokoladekugler', 50, 'g', 14),
('pink kagestøv', 1, 'knivspids', 14),
